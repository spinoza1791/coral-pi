...
class PiVideoStream:
	def __init__(self):
		...
		self.engine = edgetpu.detection.engine.DetectionEngine(str("/home/pi/python-tflite-source/edgetpu/test_data/mobilenet_ssd_v2_face_quant_postprocess_edgetpu.tflite"))
		self.frame = None
		self.stopped = False
